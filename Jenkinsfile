        ...
        stage('Deploy') {
            steps {
                sh '''
                    ...
                    aws configure list
                    /home/linuxbrew/.linuxbrew/bin/copilot init --app todo-list --name todo-list --type "Load Balanced Web Service" --dockerfile "./Dockerfile" --deploy --profile default --default-config
